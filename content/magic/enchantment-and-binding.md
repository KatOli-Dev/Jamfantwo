...
The [Heartwood Fellowship](/content/government/local/heartwood-fellowship) holds a similar view, and the Fellowship's practitioners in the [Aethelar Heartwood](/content/location/natural/ecosystem/aethelar-heartwood) have developed methods of enchantment that rely upon the deep attunement of the practitioner to the patterns of the forest. The Fellowship holds that an enchanted object is one that has been brought into harmony with the deeper patterns of the world, and the binding that holds the enchantment is a reflection of that harmony.

The [Khalisar Council](/content/government/local/khalisar-council) approaches enchantment from a more practical perspective, holding that an enchanted object is one that has been made more useful through the fixing of its pattern. The Council's practitioners are skilled in the enchantment of tools, buildings, and the infrastructure of the cities, and the Council's methods are valued by the merchants and magistrates who depend upon the reliability of enchanted objects.
...
The [Velden Compact](/content/government/local/velden-compact) has developed methods of enchantment that involve the use of relics. A practitioner who works through a relic may achieve an enchantment that is stronger and more enduring than one achieved through direct working, for the relic itself carries a resonance that reinforces the binding. The Compact's practitioners are particularly skilled in the enchantment of wood and rope, for the patterns of a vessel must be bound against the constant movement of the sea.
...
The dwarven practitioners of the mountain holds are also skilled in the enchantment of tools, but their methods differ from the methods of the surface traditions. The dwarven approach to enchantment is artisanal rather than systematic, and a dwarven practitioner who enchants a tool does so as part of the craft of making the tool rather than as a separate working. The dwarf who forges a blade and enchants it in the forging produces a blade that is more enduring and more effective than a blade that is forged first and enchanted later.
...
The principal limit on enchantment is the tendency of patterns to settle back toward their original configuration. The practitioner who would create an enduring enchantment must overcome this tendency through a binding that is strong enough to resist the reverberation, and the strength of the binding depends on the depth of the attunement and the skill of the practitioner.

## Unbinding

The reversal of enchantment is called unbinding, and it is a working in which the practitioner releases the binding that holds the pattern in its enchanted configuration. Unbinding is more difficult than binding in most cases, for the practitioner who would unbind an enchantment must read the original binding and find the point at which the binding may be released without harming the object.
