...
The cartographers of the [Spherical Cartography](/content/belief/science/theoretical/spherical-cartography) observe that the hypothesis, if true, would require that the surface of the world was once very different from what it is now, and they ask what force could have lifted the mountains and drained the seas from the lands. The philosophers reply that the lifting of the mountains is the work of the [Underlying Fire](/content/belief/science/theoretical/underlying-fire), and that the two doctrines are not inconsistent but complementary.
